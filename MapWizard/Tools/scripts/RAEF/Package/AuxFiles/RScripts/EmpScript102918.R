...
EmpWindow <- gwindow("Empirical Option") 
...
lbl_data_frame_name <- glabel(                                                                          
  "Select Sample Sim File:",
  container = EmpWindow )
MM4File <<- gfilebrowse( text = "Select a Sim file...", type = "open", container = EmpWindow )                  ### browse for the Simulation ef file - SimFile 
addhandlerchanged(MM4File , handler=function(h,...){}) 
