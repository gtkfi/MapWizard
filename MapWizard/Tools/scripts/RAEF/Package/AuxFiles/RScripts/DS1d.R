...
if (max(ID3) == 4) { NamesDC <<- c("SimIndex",paste(GN1,"_Con_Depth Cat 1",sep=""), paste(GN1,"_Con_Depth Cat 2",sep=""),paste(GN1,"_Con_Depth Cat 3",sep=""),paste(GN1,"_Con_Depth Cat 4",sep=""),paste(GN1,"_Rec_Depth Cat 1",sep=""), paste(GN1,"_Rec_Depth Cat 2",sep=""),paste(GN1,"_Rec_Depth Cat 3",sep=""),paste(GN1,"_Rec_Depth Cat 4",sep=""))}
if (max(ID3) == 3) { NamesDC <<- c("SimIndex",paste(GN1,"_Con_Depth Cat 1",sep=""), paste(GN1,"_Con_Depth Cat 2",sep=""),paste(GN1,"_Con_Depth Cat 3",sep=""),"NA",paste(GN1,"_Rec_Depth Cat 1",sep=""), paste(GN1,"_Rec_Depth Cat 2",sep=""),paste(GN1,"_Rec_Depth Cat 3",sep=""),"NA")}
if (max(ID3) == 2) { NamesDC <<- c("SimIndex",paste(GN1,"_Con_Depth Cat 1",sep=""), paste(GN1,"_Con_Depth Cat 2",sep=""),"NA",paste(GN1,"_Rec_Depth Cat 1",sep=""), paste(GN1,"_Rec_Depth Cat 2",sep=""),"NA")}
if (max(ID3) == 1) { NamesDC <<- c("SimIndex",paste(GN1,"_Con_Depth Cat 1",sep=""), "NA",paste(GN1,"_Rec_Depth Cat 1",sep=""),"NA")}
