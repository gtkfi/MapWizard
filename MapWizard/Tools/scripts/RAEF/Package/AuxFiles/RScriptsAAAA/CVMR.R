...
for (CVObj in CVList)
{
	...
	if (svalue(CVObj) == -999)
		...
		{
		print("There are missing commodity values, please correct them before continuing, by filling out the next dialogs") 
		sw <<- 2
		print ( "TRUE")
...
print("All data has been checked and confirmed") 
