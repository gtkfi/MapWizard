# Modified version of USGS RAEF(Resource Assesment Economic Filter) R-script for MapWizard software.
# Modified by Sakari Hautala
# This version is used from the command line, and skips the RGui altogether.
# Original script:
			#######################################################################
...
LaunchWithPresetParameters<<-function(presetFile,workingDir, simFile)
	{
...
#SimFile <<- simFile                 ### browse for the Simulation ef file - SimFile 
wdir1 <<- workingDir
setwd(wdir1)                                                                                     
...
print("Parameters file complete")
...
SR <<- ((18.634 * (DepthM^3 / ShortTons ) - 1))
...
## Step 005 Aggregate Deposits
	   ...
	   source(R0001)
print("Aggregation of deposits complete")
	   
## Step 006 Contained Stats

	  source(R0002) 
	
print("Contained stats complete")	
...
print("10 Cat Depth stats complete")
## Step 009 Generate Table for Plots
source(BE01)

print("Generating table for plots complete")
## Step 010 Download Ore Value / Metric Tons Plot		
source(BE02)
print("Ore Value/Metric Tons Plot complete")
## Step 011 Download Cutoff Grade / Metric Tons Plot 	
source(BE03)
print("Cutoff Grade / Metric Tons plot complete")
...
InputFolder1 <<-args[1]	#RAEF package folder
PreSetFile <<-args[2]	#Batch Preset File
WorkingDir<<-args[3]	#Working(output) directory
SimFile<<-args[4]		#Simulation file

LaunchWithPresetParameters(PreSetFile, WorkingDir, SimFile)
