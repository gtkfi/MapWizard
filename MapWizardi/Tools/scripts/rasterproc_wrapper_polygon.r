...
#mask_ras<-raster_mask_polygon(inras,breakval,outMaskedPdf,outMaskedImg,outPolyP,outPolyF,bgEvid,outPolyMap)
mask_ras<-raster_mask_polygon(inras,outPolyP,outPolyF)
