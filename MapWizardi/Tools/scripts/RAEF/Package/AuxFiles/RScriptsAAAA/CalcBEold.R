...
## for loop
for (Num1 in 1:Max1)   ## for the number of row is less than the max plus 1
	{
	...
	#######################################################BE_CUEQ_Rev
	BE_CUEQ_Rev <- (100* BE_V_Rev)/(0.91*3814)
	...
	####################BE_G(CUEQ)
	BE_CUEQ <- (100*BE_V_Rev)/(0.91*3814)
	####################CUEQDiff
	CUEQ_Diff <- (BE_CUEQ - CUEQ[Num1])/CUEQ[Num1]
	####################Smelting Cost Differential 
	SCD <- 1.26*(CUEQ_Diff*SCR[Num1])
...
##Open Pit
BE_CUEQ_OP <- (100*BE_OP)/(0.91*3814)

##Block Caving
BE_CUEQ_BC <- (100*BE_BC)/(0.91*3814)
#######################################################CUEQDiff
##Open Pit
...
#######################################################BE_CUEQ_Rev
## Open Pit
BE_CUEQ_Rev_OP <- (100* BE_V_Rev_OP)/(0.91*3814)
## Block Caving
BE_CUEQ_Rev_BC <- (100* BE_V_Rev_BC)/(0.91*3814)
...
###############################################################
################################################################################ While statement for iterations
############################################################### 
run1 <- 1
while (run1 < 20)
{
####################BE_G(CUEQ)
##Open Pit
BE_CUEQ_OP <- (100*BE_V_Rev_OP)/(0.91*3814)

##Block Caving
BE_CUEQ_BC <- (100*BE_V_Rev_BC)/(0.91*3814)
...
################################################################################ End While statement for iterations
############################################################### 
